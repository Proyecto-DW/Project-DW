...
namespace appbeneficiencia.Migrations
{
    ...
    partial class BeneficiariosdbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("appbeneficiencia.Models.AsignacionBeneficio", b =>
                {
                    ...
                    b.HasIndex(new[] { "IdBeneficiario" }, "IX_AsignacionBeneficios_IdBeneficiario");

                    b.HasIndex(new[] { "IdBeneficio" }, "IX_AsignacionBeneficios_IdBeneficio");
            ...
            modelBuilder.Entity("appbeneficiencia.Models.Beneficiario", b =>
                {
                    ...
                    b.HasIndex(new[] { "IdPadre" }, "IX_Beneficiarios_IdPadre");
            ...
            modelBuilder.Entity("appbeneficiencia.Models.Colaboradore", b =>
                {
                    ...
                    b.HasIndex(new[] { "IdPuesto" }, "IX_Colaboradores_IdPuesto");
            ...
            modelBuilder.Entity("appbeneficiencia.Models.Operacion", b =>
                {
                    ...
                    b.HasIndex(new[] { "IdModulo" }, "IX_Operacion_IdModulo");
            ...
            modelBuilder.Entity("appbeneficiencia.Models.Patrocinadore", b =>
                {
                    ...
                    b.Property<DateTime?>("FechaNacimientoBeneficiario")
                        .HasColumnType("date")
                        .HasColumnName("FechaNacimiento_Beneficiario");
                    ...
                    b.Property<string>("SoporteBenneficiariosRegistrados")
                        .HasMaxLength(250)
                        .IsUnicode(false)
                        .HasColumnType("varchar(250)");
            ...
            modelBuilder.Entity("appbeneficiencia.Models.Patrocinio", b =>
                {
                    ...
                    b.HasIndex(new[] { "IdBeneficiario" }, "IX_Patrocinio_IdBeneficiario");

                    b.HasIndex(new[] { "IdPatrocinador" }, "IX_Patrocinio_IdPatrocinador");
            ...
            modelBuilder.Entity("appbeneficiencia.Models.RolOperacion", b =>
                {
                    ...
                    b.HasIndex(new[] { "IdOperacion" }, "IX_Rol_operacion_IdOperacion");

                    b.HasIndex(new[] { "IdRol" }, "IX_Rol_operacion_IdRol");
            ...
            modelBuilder.Entity("appbeneficiencia.Models.Beneficiario", b =>
                {
                    b.HasOne("appbeneficiencia.Models.Colaboradore", "IdColaboradorNavigation")
            ...
            modelBuilder.Entity("appbeneficiencia.Models.Patrocinadore", b =>
                {
                    b.HasOne("appbeneficiencia.Models.Beneficiario", "IdBeneficiarioNavigation")
                        ...
                        .HasForeignKey("IdBeneficiario")
                        .HasConstraintName("FK_Patrocinadores_Beneficiarios");
